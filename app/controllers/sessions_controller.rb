class SessionsController < ApplicationController
  ...
  def create
    ...
    redirect_to 'https://pom-planner-be.herokuapp.com/api/v1/auth/google_oauth2?prompt=select_account'
  end
  ...
  def destroy
    response = pom_planner_service.delete_url('https://pom-planner-be.herokuapp.com/api/v1/logout')
