class SessionsController < ApplicationController
  ...
  def create
    ...
    redirect_to 'https://https://pom-planner-be-31825074f3c8.herokuapp.com/api/v1/auth/google_oauth2?prompt=select_account'
  end
  ...
  def destroy
    response = pom_planner_service.delete_url('https://https://pom-planner-be-31825074f3c8.herokuapp.com/api/v1/logout')
